              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Planificación de franjas, docentes y recintos físicos (US-ACA-03)', style: AppTextStyles.bodyMedium),
                  ],
                ),
              ),
              ElevatedButton.icon(
                onPressed: () => context.read<AcademicoBloc>().add(const LoadAcademicoDataEvent()),
                ...
                if (state is AcademicoLoaded) {
                  if (state.asignaciones.isEmpty) {
                    return Center(
                      child: Column(
                        ...
                        children: [
                          Icon(Icons.schedule_rounded, size: 48, color: AppColors.textMuted.withOpacity(0.5)),
                          const SizedBox(height: 16),
                          Text('No hay asignaciones horarias activas', style: AppTextStyles.h3),
                          const SizedBox(height: 6),
                          Text('Las asignaciones registradas desde el planificador aparecerán aquí.', style: AppTextStyles.bodyMedium),
                        ],
                      ),
                    );
                  }
                  return ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final diaStr = (a.diaSemana >= 1 && a.diaSemana <= 7) ? _dias[a.diaSemana - 1] : 'Día ${a.diaSemana}';
                      ...
                      return Card(
                        child: ListTile(
                          ...
                          leading: CircleAvatar(
                            ...
                            child: const Icon(Icons.class_outlined, color: AppColors.primaryAccent),
                          ),
                          title: Text(
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: a.estado == 'CONFIRMADA' ? AppColors.statusSuccessBg : AppColors.statusInfoBg,
                                  borderRadius: BorderRadius.circular(12),
                                ),
                                child: Text(
                                  a.estado,
                                  style: AppTextStyles.bodySmall.copyWith(
                                    color: a.estado == 'CONFIRMADA' ? AppColors.statusSuccessText : AppColors.statusInfoText,
