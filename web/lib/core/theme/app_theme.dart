...
// Paleta de colores, tipografía y tokens de diseño del sistema para Consola Web.
  ...
  static InputDecorationTheme _inputTheme({required bool light}) {
    ...
    return InputDecorationTheme(
      ...
      focusedBorder: const OutlineInputBorder(
        borderRadius: SIAASpacing.radiusSm,
        borderSide: BorderSide(color: SIAAColors.primary500, width: 2),
      ),
      errorBorder: const OutlineInputBorder(
        borderRadius: SIAASpacing.radiusSm,
        borderSide: BorderSide(color: SIAAColors.asistenciaAusente),
      ),
